    ...
    return (
        <section id="window-content">
            <div className="content">
                <h1 className="text-4xl text-center font-bold mt-3">Hi! I&#39;m Dorian</h1>
                <h5 className="text-2xl text-center font-bold">Freelance Web & App Developer</h5>
                ...
                <p className="text-center px-14 mt-10">
                    If you&#39;re looking for someone capable of creating the website or application you need and deserve, it would be my pleasure to help and accompany you throughout the entire process.
                </p>
            </div>
        </section>
    )
